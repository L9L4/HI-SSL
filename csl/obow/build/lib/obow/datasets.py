...
def get_Optional_data_for_obow(
    data_dir,
    cjitter=[0.4, 0.4, 0.4, 0.1],
    cjitter_p=0.8,
    gray_p=0.2,
    ...
    img_patch_jitter=24,
    only_patches=False,
    mean_ = _MEAN_PIXEL_IMAGENET,
    std_ = _STD_PIXEL_IMAGENET):
...
def get_data_loaders_for_OBoW(
    ...
    **kwargs):
    ...
    elif dataset_name == "Optional":
        dataset_train, dataset_test = get_Optional_data_for_obow(data_dir, **kwargs)
    else:
